...
export let TextInput = class {
    constructor(form, elementRef, config, renderer, app, platform, scrollView) {
...
TextInputElement = __decorate([
    ...
    __param(3, Optional()), 
    __metadata('design:paramtypes', [String, (typeof (_h = typeof ElementRef !== 'undefined' && ElementRef) === 'function' && _h) || Object, (typeof (_j = typeof Renderer !== 'undefined' && Renderer) === 'function' && _j) || Object, TextInput])
], TextInputElement);
...
InputScrollAssist = __decorate([
    ...
    __metadata('design:paramtypes', [(typeof (_k = typeof Form !== 'undefined' && Form) === 'function' && _k) || Object, TextInput])
], InputScrollAssist);
