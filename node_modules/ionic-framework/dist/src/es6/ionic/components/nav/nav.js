...
import { ElementRef, Optional, NgZone, Compiler, AppViewManager, DynamicComponentLoader, Renderer } from 'angular2/angular2';
...
export let Nav = class extends NavController {
    constructor(hostNavCtrl, viewCtrl, app, config, elementRef, compiler, loader, viewManager, zone, renderer) {
